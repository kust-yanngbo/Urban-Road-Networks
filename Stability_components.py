...
for i in range(6):  
    ...
    file_path = r'data\\Robustness\\' + Graph[i] +'_2_' + attack[0] + '.csv'
...
plt.savefig('figure/Stability_components.eps', dpi=600, bbox_inches='tight')
plt.savefig('figure/Stability_components.svg', dpi=600, bbox_inches='tight')
plt.show()